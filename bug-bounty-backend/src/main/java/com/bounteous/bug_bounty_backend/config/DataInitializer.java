...
public class DataInitializer {
    ...
    public CommandLineRunner initData(DataSource dataSource) {
        return args -> {
            ...
            // Create developers (existing + new ones)
            createDevelopers(now);
            
            // Create companies (existing + new ones)
            createCompanies(now);

            // Create tech stacks
            createTechStacks();

            // Create bugs (existing ones)
            createBugs(now);

            // Create bug-techstack relationships
    ...
    private void createDevelopers(String now) {
        ...
        jdbcTemplate.update("INSERT INTO developers (id, username, rating, points) VALUES (1, 'hahaha', 0.0, 0)");
        ...
        jdbcTemplate.update("INSERT INTO developers (id, username, rating, points) VALUES (3, 'sarahcodes', 0.0, 0)");

        // New developers - compact format
        String[][] developers = {
            {"5", "mike@dev.com", "password123", "Mike", "Chen", "mikecode", "0.0", "0"},
            {"6", "emma@dev.com", "password123", "Emma", "Wilson", "emmawilson", "0.0", "0"},
            {"7", "alex@dev.com", "password123", "Alex", "Rodriguez", "alexrod", "0.0", "0"},
    ...
    private void createCompanies(String now) {
        ...
        jdbcTemplate.update("INSERT INTO company (id, company_name) VALUES (2, 'Example Tech Corp')");
        ...
        jdbcTemplate.update("INSERT INTO company (id, company_name) VALUES (4, 'Tech Solutions Inc')");

        // New companies - compact format
        String[][] companies = {
    ...
    private void createLearningResources(String now) {
        // Learning resources - compact format
        String[][] resources = {
            // Tutorial resources
            ...
            {"22", "React Testing Library Examples", "Comprehensive testing examples for React applications", "https://testing-library.com/docs/react-testing-library/intro/", "CODE_EXAMPLE", "17"},
