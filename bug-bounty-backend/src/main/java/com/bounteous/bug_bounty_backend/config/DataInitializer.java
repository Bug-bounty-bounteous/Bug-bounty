    ...
    public CommandLineRunner initData(DataSource dataSource) {
        return args -> {
            ...
            jdbcTemplate.update(
                ...
                "VALUES (1, 'Hadiyahia@hadi.com', ?, 'Hadi', 'Yahia', 'DEVELOPER', false, 0, ?, ?)",
            ...
            jdbcTemplate.update(
                "INSERT INTO users (id, email, password, first_name, last_name, role, account_locked, failed_attempts, created_at, updated_at) " +
                "VALUES (2, 'company@example.com', ?, 'Example', 'Company', 'COMPANY', false, 0, ?, ?)",
...
//
            ...
            executeSql(
                ...
                "(2, 3), (2, 10), " +          // Bug 2: Angular, JavaScript
                "(3, 1), (3, 2), " +           // Bug 3: Java, Spring Boot
                "(4, 3), (4, 10), " +          // Bug 4: Angular, JavaScript
                "(5, 2), (5, 15), " +          // Bug 5: Spring Boot, RESTful API
                "(6, 2), (6, 11), " +          // Bug 6: Spring Boot, MySQL
                "(7, 3), (7, 10), " +          // Bug 7: Angular, JavaScript
                "(8, 3), (8, 10), " +          // Bug 8: Angular, JavaScript
                "(9, 2), (9, 15), " +          // Bug 9: Spring Boot, RESTful API
                "(10, 1), (10, 2), (10, 11), " + // Bug 10: Java, Spring Boot, MySQL
                "(11, 2), (11, 11), " +        // Bug 11: Spring Boot, MySQL
